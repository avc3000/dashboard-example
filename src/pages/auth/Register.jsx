  ...
  return (
    <div className='min-h-screen flex items-center justify-center p-4'>
      <div className="bg-secondary-100 p-8 rounded-xl shadow-2xl w-auto lg:w-[450px]">
        <h1 className="text-3xl uppercase font-bold tracking-[5px] text-white mb-8">Create Account</h1>
        <form className='mb-6'>
          ...
          <div className='relative mb-4'>
            ...
            <input type="text" placeholder='First Name' className='py-2 pl-8 pr-4 bg-secondary-900 w-full outline-none rounded-lg focus:border focus:border-primary' />
          </div>
          <div className='relative mb-4'>
            <RiUserLine className='absolute top-1/2 -translate-y-1/2 left-2 text-primary' />
            <input type="text" placeholder='Last Name' className='py-2 pl-8 pr-4 bg-secondary-900 w-full outline-none rounded-lg focus:border focus:border-primary' />
          </div>
          <div className='relative mb-4'>
          ...
          <div className='relative mb-4'>
            <RiLockLine className='absolute top-1/2 -translate-y-1/2 left-2 text-primary' />
            <input type={showPassword ? 'text' : 'password'} placeholder='Confirm Password' className='py-2 pl-8 pr-4 bg-secondary-900 w-full outline-none rounded-lg focus:border focus:border-primary' />
            {
              showPassword ? (
                <RiEyeOffLine onClick={() => setShowPassword(!showPassword)} className='absolute top-1/2 -translate-y-1/2 right-2 hover:cursor-pointer text-primary' />
              ) : (
          ...
          <div>
            <button type='submit' className='bg-primary text-black w-full py-3 px-4 font-bold rounded-lg hover:text-white transition-colors'>Register</button>
          </div>
        </form>
        <div className='flex flex-col items-center gap-4'>
          <Link to='/login' className='text-gray-100 hover:text-primary transition-colors'>You ready have an account?</Link>
        </div>
      </div>
    </div>
  )
